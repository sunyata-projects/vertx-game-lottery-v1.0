 ...
 */
@Component(Commands.RegularPlay)
public class RegularPlayCommandHandler extends AbstractGameControllerCommandHandler {
    class CommandErrorCode {

    }

    Logger logger = LoggerFactory.getLogger(RegularPlayCommandHandler.class);
    ...
    public void execute(OctopusRequest request, OctopusResponse response) throws Exception {
        try {
            if (!this.canAccpet(request, GameRegularEvent.Play)) {
...
//            }
            ...
            gameController.fire(GameRegularEvent.Play, gameModel);
...
//    public RegularPlayPhaseDataItem generatorPlayDataItem(GameRegularModel gameModel) {
//
//        return item;
//    }
