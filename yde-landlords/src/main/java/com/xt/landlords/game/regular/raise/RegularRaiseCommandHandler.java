package com.xt.landlords.game.regular.raise;
...
public class RegularRaiseCommandHandler extends AbstractGameControllerCommandHandler {
    ...
    public void execute(OctopusRequest request, OctopusResponse response) throws Exception {
        try {
            ...
            phaseData.getBetAmt();
            RaisePhaseModel raiseBetPhaseModel = new RaisePhaseModel();
            raiseBetPhaseModel.setPhaseData(new RaisePhaseData().setTimes(times).setBetAmt(phaseData.getBetAmt()));
