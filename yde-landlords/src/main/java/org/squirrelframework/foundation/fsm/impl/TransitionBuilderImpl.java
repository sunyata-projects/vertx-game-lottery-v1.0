...
class TransitionBuilderImpl<T extends StateMachine<T, S, E, C>, S, E, C> implements 
    ...
    public void callMethod(final String methodName) {
        Action<T, S, E, C> action = org.squirrelframework.foundation.fsm.impl.FSM.newMethodCallActionProxy(methodName, executionContext);
        transition.addAction(action);
    }
    ...
    public To<T, S, E, C> to(S stateId) {
        targetState = org.squirrelframework.foundation.fsm.impl.FSM.getState(states, stateId);
        return this;
    }
    ...
    public From<T, S, E, C> from(S stateId) {
        sourceState = org.squirrelframework.foundation.fsm.impl.FSM.getState(states, stateId);
        return this;
    }
    ...
    public To<T, S, E, C> within(S stateId) {
        sourceState = targetState = org.squirrelframework.foundation.fsm.impl.FSM.getState(states, stateId);
        return this;
    }
}
