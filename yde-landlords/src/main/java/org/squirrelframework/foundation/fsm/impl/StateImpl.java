...
class StateImpl<T extends StateMachine<T, S, E, C>, S, E, C> implements MutableState<T, S, E, C> {
    ...
    protected final Actions<T, S, E, C> entryActions = org.squirrelframework.foundation.fsm.impl.FSM.newActions();
    
    protected final Actions<T, S, E, C> exitActions  = org.squirrelframework.foundation.fsm.impl.FSM.newActions();
    ...
    public MutableTransition<T, S, E, C> addTransitionOn(E event) {
        MutableTransition<T, S, E, C> newTransition = org.squirrelframework.foundation.fsm.impl.FSM.newTransition();
        ...
        if(isParallelState()) {
            ...
            for(ImmutableState<T, S, E, C> parallelState : parallelStates) {
                ...
                TransitionResult<T, S, E, C> subTransitionResult =
                        org.squirrelframework.foundation.fsm.impl.FSM.<T, S, E, C>newResult(false, parallelState, currentTransitionResult);
                StateContext<T, S, E, C> subStateContext = org.squirrelframework.foundation.fsm.impl.FSM.newStateContext(
        ...
        for(final ImmutableTransition<T, S, E, C> transition : transitions) {
            ...
            if(currentTransitionResult.isAccepted()) {
                ...
                if(targetState.isFinalState() && !targetState.isRootState()) {
                    ...
                    StateContext<T, S, E, C> finishContext = org.squirrelframework.foundation.fsm.impl.FSM.newStateContext(
