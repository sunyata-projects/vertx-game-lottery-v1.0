 ...
 */
public interface StateMachineBuilder<T extends org.squirrelframework.foundation.fsm.StateMachine<T, S, E, C>, S, E, C> {
     ...
     */
    org.squirrelframework.foundation.fsm.MutableState<T, S, E, C> defineState(S stateId);
     ...
     */
    org.squirrelframework.foundation.fsm.MutableState<T, S, E, C> defineFinalState(S stateId);
     ...
     * @return linked state
     */
    org.squirrelframework.foundation.fsm.MutableState<T, S, E, C> defineLinkedState(S stateId,
                                                                                    StateMachineBuilder<? extends org
                                                                                            .squirrelframework
                                                                                            .foundation.fsm
                                                                                            .StateMachine<?, S, E,
                                                                                            C>, S, E, C>
                                                                                            linkedStateMachineBuilder,
     ...
     * @param childStateIds child states id of parent state. The first child state will be used as initial child state of parent state.
     */
    void defineSequentialStatesOn(S parentStateId, org.squirrelframework.foundation.fsm.HistoryType historyType, S...
            childStateIds);
