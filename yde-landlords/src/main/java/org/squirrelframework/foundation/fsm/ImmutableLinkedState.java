 ...
 */
public interface ImmutableLinkedState<T extends org.squirrelframework.foundation.fsm.StateMachine<T, S, E, C>, S, E, C> extends org.squirrelframework.foundation.fsm.ImmutableState<T, S, E, C> {
