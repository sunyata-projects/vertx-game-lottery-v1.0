 ...
 *            type of Context
 */
public interface StateMachineData<T extends org.squirrelframework.foundation.fsm.StateMachine<T, S, E, C>, S, E, C> extends Serializable {
    /**
    ...
    public interface Reader<T extends org.squirrelframework.foundation.fsm.StateMachine<T, S, E, C>, S, E, C> extends Serializable {
        /**
         ...
         */
        org.squirrelframework.foundation.fsm.ImmutableState<T, S, E, C> currentRawState();

        /**
         * @return last active raw state of state machine
         */
        org.squirrelframework.foundation.fsm.ImmutableState<T, S, E, C> lastRawState();

        /**
         * @return initial raw state of state machine
         */
        org.squirrelframework.foundation.fsm.ImmutableState<T, S, E, C> initialRawState();
         ...
         */
        org.squirrelframework.foundation.fsm.ImmutableState<T, S, E, C> rawStateFrom(S stateId);
         ...
         */
        Collection<org.squirrelframework.foundation.fsm.ImmutableState<T, S, E, C>> rawStates();
        ...
        Map<S, org.squirrelframework.foundation.fsm.ImmutableState<T, S, E, C>> originalStates();

        Reader<? extends org.squirrelframework.foundation.fsm.StateMachine<?, S, E, C>, S, E, C> linkedStateDataOf(S linkedState);
    }

    public interface Writer<T extends org.squirrelframework.foundation.fsm.StateMachine<T, S, E, C>, S, E, C> extends Serializable {
        ...
        void linkedStateDataOn(
                S linkedState,
                Reader<? extends StateMachine<?, S, E, C>, S, E, C> linkStateData);
    }
}
