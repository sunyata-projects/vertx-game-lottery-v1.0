...
class LinkedStateImpl<T extends StateMachine<T, S, E, C>, S, E, C> extends org.squirrelframework.foundation.fsm.impl.StateImpl<T, S, E, C>
    ...
    public void internalFire(StateContext<T, S, E, C> stateContext) {
        ...
        if(stateMachine.getStatus()==StateMachineStatus.TERMINATED) {
            ...
            try {
                ...
                // removeFromLocal declined event listener
