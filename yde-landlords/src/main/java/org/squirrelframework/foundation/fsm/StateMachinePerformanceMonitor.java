...
public class StateMachinePerformanceMonitor {
    ...
    @OnStateMachineStart
    public void onStateMachineStart(org.squirrelframework.foundation.fsm.StateMachine<?,?,?,?> fsm) {
    ...
    public void onStateMachineTerminate(org.squirrelframework.foundation.fsm.StateMachine<?,?,?,?> fsm) {
        transitionWatches.remove(fsm.getIdentifier());
        actionWatches.remove(fsm.getIdentifier());
    }
    
    @OnTransitionBegin
    public void onTransitionBegin(org.squirrelframework.foundation.fsm.StateMachine<?,?,?,?> fsm) {
        waitIfBusyStat();
    ...
    public void onTransitionEnd(Object sourceState, Object targetState, 
            Object event, Object context, org.squirrelframework.foundation.fsm.StateMachine<?,?,?,?> fsm) {
        waitIfBusyStat();
    ...
    public void onBeforeActionExecuted(org.squirrelframework.foundation.fsm.StateMachine<?,?,?,?> fsm, org.squirrelframework.foundation.fsm.Action<?, ?, ?,?> action) {
        waitIfBusyStat();
        actionWatches.get(fsm.getIdentifier()).reset().start();
    }
    
    @OnAfterActionExecuted
    public void onAfterActionExecuted(org.squirrelframework.foundation.fsm.StateMachine<?,?,?,?> fsm, org.squirrelframework.foundation.fsm.Action<?, ?, ?,?> action) {
        waitIfBusyStat();
    ...
    public synchronized org.squirrelframework.foundation.fsm.StateMachinePerformanceModel getPerfModel() {
        isBusyStat = true;
        
        org.squirrelframework.foundation.fsm.StateMachinePerformanceModel perfModel = new StateMachinePerformanceModel();
