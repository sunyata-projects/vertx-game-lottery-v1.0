...
public interface Actions<T extends StateMachine<T, S, E, C>, S, E, C> extends SquirrelComponent {
     ...
     */
    void add(org.squirrelframework.foundation.fsm.Action<T, S, E, C> newAction);
    
    /**
     * Add a list of new actions
     * @param newActions new actions
     */
    void addAll(List<? extends org.squirrelframework.foundation.fsm.Action<T, S, E, C>> newActions);
    
    /**
     * @return all sorted actions
     */
    List<org.squirrelframework.foundation.fsm.Action<T, S, E, C>> getAll();
