 ...
 * builder, so user can register different implementation class of {@link org.squirrelframework.foundation.fsm.StateMachineBuilder} to instantiate different
...
public class StateMachineBuilderFactory {
    ...
    public static UntypedStateMachineBuilder create(Class<? extends org.squirrelframework.foundation.fsm.UntypedStateMachine> stateMachineClazz) {
        return create(stateMachineClazz, new Class[0]);
    }
    
    public static UntypedStateMachineBuilder create(Class<? extends org.squirrelframework.foundation.fsm.UntypedStateMachine> stateMachineClazz,
            Class<?>... extraConstParamTypes) {
        final org.squirrelframework.foundation.fsm.StateMachineBuilder<org.squirrelframework.foundation.fsm.UntypedStateMachine, Object, Object, Object> builder =
    ...
    public static UntypedStateMachineBuilder create(
            final org.squirrelframework.foundation.fsm.StateMachineBuilder<UntypedStateMachine, Object, Object, Object> builder) {
                    ...
                    public Object invoke(Object proxy, Method method, Object[] args)
                        ...
                        try {
                            ...
                            if(methodName.equals("newUntypedStateMachine") || methodName.equals("newAnyStateMachine")) {
                                ...
                                if(args.length==3 && org.squirrelframework.foundation.fsm.StateMachineConfiguration.class.isAssignableFrom(args[1].getClass()) &&
    ...
    public static <T extends org.squirrelframework.foundation.fsm.StateMachine<T, S, E, C>, S, E, C> org.squirrelframework.foundation.fsm.StateMachineBuilder<T, S, E, C> create(
    ...
    public static <T extends StateMachine<T, S, E, C>, S, E, C> org.squirrelframework.foundation.fsm.StateMachineBuilder<T, S, E, C> create(
            Class<? extends T> stateMachineClazz, Class<S> stateClazz, Class<E> eventClazz, Class<C> contextClazz, 
            Class<?>... extraConstParamTypes) {
