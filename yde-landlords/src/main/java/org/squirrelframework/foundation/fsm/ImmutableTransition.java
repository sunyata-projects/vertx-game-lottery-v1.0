 ...
 */
public interface ImmutableTransition<T extends org.squirrelframework.foundation.fsm.StateMachine<T, S, E, C>, S, E, C>  extends Visitable, SquirrelComponent {
    
    /**
     * @return Transition source state
     */
    org.squirrelframework.foundation.fsm.ImmutableState<T, S, E, C> getSourceState();
    
    /**
     * @return Transition destination state
     */
    org.squirrelframework.foundation.fsm.ImmutableState<T, S, E, C> getTargetState();
     ...
     */
    ImmutableState<T, S, E, C> transit(org.squirrelframework.foundation.fsm.StateContext<T, S, E, C> stateContext);
     ...
     */
    org.squirrelframework.foundation.fsm.TransitionType getType();
