 ...
 */
public interface ImmutableState<T extends org.squirrelframework.foundation.fsm.StateMachine<T, S, E, C>, S, E, C>  extends Visitable, SquirrelComponent {
     ...
     */
    List<org.squirrelframework.foundation.fsm.Action<T, S, E, C>> getEntryActions();
     ...
     * @param stateContext
     */
    void entry(org.squirrelframework.foundation.fsm.StateContext<T, S, E, C> stateContext);
     ...
     */
    ImmutableState<T, S, E, C> enterByHistory(org.squirrelframework.foundation.fsm.StateContext<T, S, E, C> stateContext);
     ...
     */
    ImmutableState<T, S, E, C> enterDeep(org.squirrelframework.foundation.fsm.StateContext<T, S, E, C> stateContext);
     ...
     */
    ImmutableState<T, S, E, C> enterShallow(org.squirrelframework.foundation.fsm.StateContext<T, S, E, C> stateContext);
    
    /**
     * Exit state with state context
     * @param stateContext
     */
    void exit(org.squirrelframework.foundation.fsm.StateContext<T, S, E, C> stateContext);
