...
public class MethodCallActionProxyImpl<T extends StateMachine<T, S, E, C>, S, E, C> implements Action<T, S, E, C> {
    ...
    MethodCallActionProxyImpl(String methodName, org.squirrelframework.foundation.fsm.impl.ExecutionContext executionContext) {
    ...
    private Action<T, S, E, C> getDelegator() {
        if(delegator==null) {
            ...
            if(method!=null) {
                delegator = org.squirrelframework.foundation.fsm.impl.FSM.newMethodCallAction(method, weight, executionContext);
            } else {
    ...
    public boolean equals(Object obj) {
        ...
        if(obj == null)
            return false;
        if(obj instanceof org.squirrelframework.foundation.fsm.impl.MethodCallActionImpl &&
