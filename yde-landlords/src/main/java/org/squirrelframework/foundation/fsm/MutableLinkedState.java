 ...
 */
public interface MutableLinkedState<T extends org.squirrelframework.foundation.fsm.StateMachine<T, S, E, C>, S, E, C> extends org.squirrelframework.foundation.fsm.MutableState<T, S, E, C> {
