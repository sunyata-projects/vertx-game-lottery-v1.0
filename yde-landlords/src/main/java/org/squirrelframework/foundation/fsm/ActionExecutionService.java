 ...
 */
public interface ActionExecutionService<T extends org.squirrelframework.foundation.fsm.StateMachine<T, S, E, C>, S, E, C> extends Observable {
    /**
     ...
     */
    void defer(org.squirrelframework.foundation.fsm.Action<T, S, E, C> action, S from, S to, E event, C context, T
            stateMachine);
     ...
     */
    public interface ActionEvent<T extends org.squirrelframework.foundation.fsm.StateMachine<T, S, E, C>, S, E, C> extends SquirrelEvent {
        org.squirrelframework.foundation.fsm.Action<T, S, E, C> getExecutionTarget();
        S getFrom();
        S getTo();
        E getEvent();
        C getContext();
    ...
    public interface BeforeExecActionEvent<T extends org.squirrelframework.foundation.fsm.StateMachine<T, S, E, C>, S, E, C> extends ActionEvent<T, S, E, C> {}

    /**
     * Before Action execution listener
     */
    public interface BeforeExecActionListener<T extends org.squirrelframework.foundation.fsm.StateMachine<T, S, E, C>, S, E, C> {
    ...
    public interface AfterExecActionEvent<T extends org.squirrelframework.foundation.fsm.StateMachine<T, S, E, C>, S, E, C> extends ActionEvent<T, S, E, C> {}
    
    /**
     * After Action execution listener
     */
    public interface AfterExecActionListener<T extends org.squirrelframework.foundation.fsm.StateMachine<T, S, E, C>, S, E, C> {
    ...
    public interface ExecActionExceptionEvent<T extends org.squirrelframework.foundation.fsm.StateMachine<T, S, E, C>, S, E, C> extends ActionEvent<T, S, E, C> {
