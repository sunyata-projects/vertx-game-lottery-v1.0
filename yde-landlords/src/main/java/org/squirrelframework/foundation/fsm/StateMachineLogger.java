...
public class StateMachineLogger {
    ...
    private final org.squirrelframework.foundation.fsm.StateMachine<?,?,?,?> stateMachine;

    private final String stateMachineLabel;

    public StateMachineLogger(org.squirrelframework.foundation.fsm.StateMachine<?,?,?,?> stateMachine) {
    ...
    public void onBeforeActionExecuted(Object sourceState, Object targetState, 
            Object event, Object context, int[] mOfN, org.squirrelframework.foundation.fsm.Action<?, ?, ?,?> action) {
