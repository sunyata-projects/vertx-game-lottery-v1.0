...
public class PuzzleCardsService {
  ...
  public interface Iface {
     ...
     * @param grade
     */
    public PuzzleCards getCards(int grade) throws org.apache.thrift.TException;

  }

  public interface AsyncIface {

    public void getCards(int grade, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void send_getCards(int grade) throws org.apache.thrift.TException
    {
    ...
    public PuzzleCards recv_getCards() throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void getCards(int grade, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException {
      checkReady();
      getCards_call method_call = new getCards_call(grade, resultHandler, this, ___protocolFactory, ___transport);
    ...
    public static class getCards_call extends org.apache.thrift.async.TAsyncMethodCall {
      private int grade;
      public getCards_call(int grade, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
      ...
      public PuzzleCards getResult() throws org.apache.thrift.TException {
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class getCards<I extends Iface> extends org.apache.thrift.ProcessFunction<I, getCards_args> {
      ...
      public getCards_result getResult(I iface, getCards_args args) throws org.apache.thrift.TException {
        getCards_result result = new getCards_result();
        result.success = iface.getCards(args.grade);
        return result;
      }
    }
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class getCards<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, getCards_args, PuzzleCards> {
      public getCards() {
        super("getCards");
      }
      ...
      public AsyncMethodCallback<PuzzleCards> getResultHandler(final AsyncFrameBuffer fb, final int seqid) {
        final org.apache.thrift.AsyncProcessFunction fcall = this;
        return new AsyncMethodCallback<PuzzleCards>() { 
          public void onComplete(PuzzleCards o) {
            getCards_result result = new getCards_result();
            result.success = o;
            try {
      ...
      public void start(I iface, getCards_args args, org.apache.thrift.async.AsyncMethodCallback<PuzzleCards> resultHandler) throws TException {
        iface.getCards(args.grade,resultHandler);
      }
    }
  ...
  public static class getCards_args implements org.apache.thrift.TBase<getCards_args, getCards_args._Fields>, java.io.Serializable, Cloneable, Comparable<getCards_args>   {
    ...
    private static final org.apache.thrift.protocol.TField GRADE_FIELD_DESC = new org.apache.thrift.protocol.TField("grade", org.apache.thrift.protocol.TType.I32, (short)1);
  ...
  public static class getCards_result implements org.apache.thrift.TBase<getCards_result, getCards_result._Fields>, java.io.Serializable, Cloneable, Comparable<getCards_result>   {
    ...
    public PuzzleCards success; // required
    ...
    static {
      ...
      tmpMap.put(_Fields.SUCCESS, new org.apache.thrift.meta_data.FieldMetaData("success", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, PuzzleCards.class)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
    ...
    public getCards_result(getCards_result other) {
      if (other.isSetSuccess()) {
        this.success = new PuzzleCards(other.success);
      }
    }
    ...
    public PuzzleCards getSuccess() {
      return this.success;
    }

    public getCards_result setSuccess(PuzzleCards success) {
      this.success = success;
      return this;
    }
          ...
          switch (schemeField.id) {
            case 0: // SUCCESS
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.success = new PuzzleCards();
