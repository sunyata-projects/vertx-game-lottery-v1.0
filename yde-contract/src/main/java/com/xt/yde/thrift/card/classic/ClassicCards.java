...
public class ClassicCards implements org.apache.thrift.TBase<ClassicCards, ClassicCards._Fields>, java.io.Serializable, Cloneable, Comparable<ClassicCards> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("ClassicCards");
  ...
  static {
    schemes.put(StandardScheme.class, new ClassicCardsStandardSchemeFactory());
    schemes.put(TupleScheme.class, new ClassicCardsTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(ClassicCards.class, metaDataMap);
  }
   ...
   */
  public ClassicCards(ClassicCards other) {
  ...
  public ClassicCards deepCopy() {
    return new ClassicCards(this);
  }
  ...
  public ClassicCards setCardId(String cardId) {
    this.cardId = cardId;
    return this;
  }
  ...
  public ClassicCards setCenter(List<Integer> center) {
    this.center = center;
    return this;
  }
  ...
  public ClassicCards setLeft(List<Integer> left) {
    this.left = left;
    return this;
  }
  ...
  public ClassicCards setRight(List<Integer> right) {
    this.right = right;
    return this;
  }
  ...
  public ClassicCards setUnder(List<Integer> under) {
    this.under = under;
    return this;
  }
  ...
  public ClassicCards setBombNumbers(int bombNumbers) {
    this.bombNumbers = bombNumbers;
    setBombNumbersIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof ClassicCards)
      return this.equals((ClassicCards)that);
    return false;
  }

  public boolean equals(ClassicCards that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(ClassicCards other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("ClassicCards(");
    boolean first = true;
  ...
  private static class ClassicCardsStandardSchemeFactory implements SchemeFactory {
    public ClassicCardsStandardScheme getScheme() {
      return new ClassicCardsStandardScheme();
    }
  }

  private static class ClassicCardsStandardScheme extends StandardScheme<ClassicCards> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, ClassicCards struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ClassicCards struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class ClassicCardsTupleSchemeFactory implements SchemeFactory {
    public ClassicCardsTupleScheme getScheme() {
      return new ClassicCardsTupleScheme();
    }
  }

  private static class ClassicCardsTupleScheme extends TupleScheme<ClassicCards> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, ClassicCards struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, ClassicCards struct) throws org.apache.thrift.TException {
