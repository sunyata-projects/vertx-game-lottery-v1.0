 ...
 *  @generated
 */
package org.sunyata.octopus.thrift;
...
public class TName implements org.apache.thrift.TBase<TName, TName._Fields>, java.io.Serializable, Cloneable, Comparable<TName> {
   ...
   * @see TStatus
   */
  public TStatus status; // optional
  ...
  public TName setFirstName(String firstName) {
    this.firstName = firstName;
    return this;
  }
  ...
  public TName setSecondName(String secondName) {
    this.secondName = secondName;
    return this;
  }
   ...
   * @see TStatus
   */
  public TName setStatus(TStatus status) {
    this.status = status;
    return this;
  }
