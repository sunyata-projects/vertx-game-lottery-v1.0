...
package com.xt.landlords.quark.quark;
 ...
 */
@Component("landlords-common-bet-quark")
@QuarkComponent(quarkName = "landlords-common-bet-quark", quarkFriendlyName = "赛事下注Quark", version = "1.0")
public class BetQuarkComponent extends AbstractQuarkComponent<BetQuarkComponent.AsyncQuarkParameterInfo> {
