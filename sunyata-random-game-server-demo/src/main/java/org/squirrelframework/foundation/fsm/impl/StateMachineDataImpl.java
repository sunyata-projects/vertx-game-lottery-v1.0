...
public class StateMachineDataImpl<T extends StateMachine<T, S, E, C>, S, E, C>
    ...
    private Map<S, Reader<? extends StateMachine<?, S, E, C>, S, E, C>> linkStateDataStore;
    ...
    @Override
    public void dump(Reader<T, S, E, C> src) {
        clear();
    ...
    private Map<S, Reader<? extends StateMachine<?, S, E, C>, S, E, C>> getLinkedStateData() {
        if (linkStateDataStore == null) {
    ...
    @Override
    public Reader<T, S, E, C> read() {
        return this;
    }

    @Override
    public Writer<T, S, E, C> write() {
        return this;
    }
    ...
    public void removeSubState(S parentStateId, S subStateId) {
        if (rawStateFrom(parentStateId) != null
            ...
            logger.warn("Cannot removeFromLocal sub states on none parallel state {}.",
                    parentStateId);
        }
    }
    ...
    @Override
    public Reader<? extends StateMachine<?, S, E, C>, S, E, C> linkedStateDataOf(
            S linkedState) {
        if (linkStateDataStore != null && !linkStateDataStore.isEmpty())
