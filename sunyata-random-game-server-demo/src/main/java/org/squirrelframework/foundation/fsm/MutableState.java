...
public interface MutableState<T extends StateMachine<T, S, E, C>, S, E, C> extends ImmutableState<T, S, E, C> {
    ...
    void addEntryAction(org.squirrelframework.foundation.fsm.Action<T, S, E, C> newAction);
    
    void addEntryActions(List<? extends org.squirrelframework.foundation.fsm.Action<T, S, E, C>> newActions);
    
    void addExitAction(org.squirrelframework.foundation.fsm.Action<T, S, E, C> newAction);
    
    void addExitActions(List<? extends org.squirrelframework.foundation.fsm.Action<T, S, E, C>> newActions);
