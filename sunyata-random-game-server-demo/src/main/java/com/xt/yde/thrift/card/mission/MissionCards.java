...
public class MissionCards implements org.apache.thrift.TBase<MissionCards, MissionCards._Fields>, java.io.Serializable, Cloneable, Comparable<MissionCards> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("MissionCards");
  ...
  static {
    schemes.put(StandardScheme.class, new MissionCardsStandardSchemeFactory());
    schemes.put(TupleScheme.class, new MissionCardsTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(MissionCards.class, metaDataMap);
  }
   ...
   */
  public MissionCards(MissionCards other) {
  ...
  public MissionCards deepCopy() {
    return new MissionCards(this);
  }
  ...
  public MissionCards setCardId(String cardId) {
    this.cardId = cardId;
    return this;
  }
  ...
  public MissionCards setCenter(List<Integer> center) {
    this.center = center;
    return this;
  }
  ...
  public MissionCards setLeft(List<Integer> left) {
    this.left = left;
    return this;
  }
  ...
  public MissionCards setRight(List<Integer> right) {
    this.right = right;
    return this;
  }
  ...
  public MissionCards setUnder(List<Integer> under) {
    this.under = under;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof MissionCards)
      return this.equals((MissionCards)that);
    return false;
  }

  public boolean equals(MissionCards that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(MissionCards other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("MissionCards(");
    boolean first = true;
  ...
  private static class MissionCardsStandardSchemeFactory implements SchemeFactory {
    public MissionCardsStandardScheme getScheme() {
      return new MissionCardsStandardScheme();
    }
  }

  private static class MissionCardsStandardScheme extends StandardScheme<MissionCards> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, MissionCards struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, MissionCards struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class MissionCardsTupleSchemeFactory implements SchemeFactory {
    public MissionCardsTupleScheme getScheme() {
      return new MissionCardsTupleScheme();
    }
  }

  private static class MissionCardsTupleScheme extends TupleScheme<MissionCards> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, MissionCards struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, MissionCards struct) throws org.apache.thrift.TException {
