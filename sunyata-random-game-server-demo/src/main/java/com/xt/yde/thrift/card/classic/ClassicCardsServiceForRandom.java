...
public class ClassicCardsServiceForRandom {
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public ClassicCardsForRandom recv_getCards() throws TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class getCards_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public ClassicCardsForRandom getResult() throws TException {
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class getCards<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, getCards_args, ClassicCardsForRandom> {
      public getCards() {
        super("getCards");
      }
      ...
      public AsyncMethodCallback<ClassicCardsForRandom> getResultHandler(final AsyncFrameBuffer fb, final int seqid) {
        final org.apache.thrift.AsyncProcessFunction fcall = this;
        return new AsyncMethodCallback<ClassicCardsForRandom>() {
          public void onComplete(ClassicCardsForRandom o) {
            getCards_result result = new getCards_result();
            result.success = o;
            try {
      ...
      public void start(I iface, getCards_args args, AsyncMethodCallback<ClassicCardsForRandom> resultHandler) throws TException {
  ...
  public static class getCards_result implements org.apache.thrift.TBase<getCards_result, getCards_result._Fields>, java.io.Serializable, Cloneable, Comparable<getCards_result>   {
    ...
    public ClassicCardsForRandom success; // required
    ...
    static {
      ...
      tmpMap.put(_Fields.SUCCESS, new org.apache.thrift.meta_data.FieldMetaData("success", org.apache.thrift.TFieldRequirementType.DEFAULT,
          new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, ClassicCardsForRandom.class)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
    ...
    public getCards_result(getCards_result other) {
      if (other.isSetSuccess()) {
        this.success = new ClassicCardsForRandom(other.success);
      }
    }
    ...
    public ClassicCardsForRandom getSuccess() {
      return this.success;
    }

    public getCards_result setSuccess(ClassicCardsForRandom success) {
      this.success = success;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case SUCCESS:
        if (value == null) {
          ...
          setSuccess((ClassicCardsForRandom)value);
        }
        break;
          ...
          switch (schemeField.id) {
            case 0: // SUCCESS
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.success = new ClassicCardsForRandom();
