...
public class DataSourceConfig {
    static final String PACKAGE = "com.xt.yde.job.model";

    @Value("${yde.job.datasource.url}")
    private String dbUrl;
    @Value("${yde.job.datasource.username}")
    private String dbUser;
    @Value("${yde.job.datasource.password}")
    ...
    public SqlSessionFactory sessionFactory(DataSource dataSource) throws
        ...
        bean.setTypeAliasesPackage("com.xt.yde.job.model");
